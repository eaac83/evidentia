...
export default function Formulario() {
  ...
  return (
    <div className="bg-[#0D1117] min-h-screen text-white py-10 px-4">
      <form onSubmit={handleSubmit} className="max-w-5xl mx-auto bg-[#1F2937] p-10 rounded-lg shadow-xl space-y-10">
        ...
        <fieldset className="border border-gray-600 p-6 rounded">
          ...
          <label className="block mt-4 mb-4">Selecciona los meses a justificar e ingresa el monto mensual</label>
