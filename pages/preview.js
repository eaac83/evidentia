...
export default function Preview() {
  ...
  useEffect(() => {
    ...
    // Cargar html2pdf desde CDN si no existe
    if (!window.html2pdf) {
  ...
  const descargarPDF = () => {
    ...
    if (window.html2pdf) {
      ...
      alert("El generador PDF aún no está listo. Intenta de nuevo en unos segundos.");
    }
  };
          ...
          <table className="w-full mb-4 border border-gray-300">
            ...
            <tbody>
              <tr>
                ...
                <td className="text-right p-2 border border-gray-300">${datos.montoCFDI?.toLocaleString()} MXN</td>
              </tr>
            </tbody>
          </table>
