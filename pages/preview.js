...
export default function Preview() {
  ...
  const renderMinuta = () => {
    ...
    const montoMes = registro.montosPorMes[mesActivo] || 0;
    return (
      <div style={estilos.hoja}>
        ...
        <p>El monto facturado por este mes fue de: <strong>${montoMes.toLocaleString()} MXN</strong></p>
  ...
  return (
    <div style={estilos.pagina}>
      ...
      <div style={estilos.hoja}>
        ...
        <p><strong>Total facturado (cliente):</strong> ${registro.montoReal.toLocaleString()} MXN</p>
        <p><strong>Total cotizado (para evidencia):</strong> ${registro.montoCotizado.toLocaleString()} MXN</p>
      </div>
      ...
      <div style={estilos.hoja}>
        ...
        <p>Monto total acordado para la prestación: <strong>${registro.montoCotizado.toLocaleString()} MXN</strong></p>
      </div>
