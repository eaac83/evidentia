...
El suscrito representante legal de \${datos.receptor} acepta la cotización correspondiente a los meses indicados, así como los términos y condiciones propuestos por el proveedor \${datos.proveedor}, por un monto total estimado de $\${Object.values(datos.montosPorMes || {}).reduce((acc, v) => acc + parseFloat(v), 0).toFixed(2)}.
