...
export default function Documentos() {
  ...
  const generarPDF = () => {
    ...
    y += 2 * lineHeight;
    doc.text("Agradecemos profundamente el interés mostrado por nuestros servicios y su confianza en nuestra empresa. Quedamos a su entera disposición para cualquier duda, comentario y/o aclaración.", margin, y, { maxWidth: 180, align: "justify" });
    ...
    const html = `
      <html xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:w='urn:schemas-microsoft-com:office:word' xmlns='http://www.w3.org/TR/REC-html40'>
        ...
        <body style='font-family:Arial;'>
          ...
          <p><strong>Cliente:</strong> ${datos.receptor}<br>
          <strong>Fecha de emisión:</strong> ${fechaTexto}</p>
          <p style='text-align:justify;'>Le enviamos un cordial saludo y un agradecimiento por el interés mostrado por nuestros servicios. Con base en las diferentes pláticas sostenidas con personal de su empresa y a efecto de continuar con la relación que hemos desarrollado con ${datos.receptor}, nos permitimos hacerle llegar la cotización de los siguientes servicios:</p>
          <p style='text-align:justify;'>${datos.descripcionCFDI}</p>
          <h3 style='text-align:center;'>COSTO</h3>
          <p style='text-align:center;'>${datos.descripcionCFDI}<br>$${total.toLocaleString("es-MX")}<br>${totalEnLetra}</p>
          ...
          <p style='text-align:justify;'>Agradecemos profundamente el interés mostrado por nuestros servicios y su confianza en nuestra empresa. Quedamos a su entera disposición.</p>
          <br><br>
  ...
  return (
    <div style={{ padding: 40 }}>
      <h2 style={{ textAlign: "center" }}>Generar documentos</h2>
