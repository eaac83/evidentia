  ...
  return (
    <div style={{ padding: 40, maxWidth: 900, margin: "auto", color: "#f0f0f0" }}>
      ...
      <div style={{ marginTop: 30 }}>
        <button
          onClick={() => alert('Descargando PDF... (esta función estará activa una vez pagado el servicio)')}
          style={{
        ...
        <button
          onClick={() => {
            const confirmacion = confirm('⚠️ La descarga en formato editable (Word) implica un cargo adicional del 10% sobre $500 + IVA.\n\nSe recomienda descargar el documento editable para poder personalizarlo con su logotipo y realizar ajustes específicos antes de enviarlo.');
            if (confirmacion) {
              alert('Función de descarga editable activada (futura implementación)');
            }
          }}
          style={{
