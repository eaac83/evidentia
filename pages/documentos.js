          ...
          <div key={mes} style={{
            ...
            <div id={`cotizacion-${mes}`} style={{
              ...
              <div style={{ marginTop: '40px' }}>
                <h4 style={{ marginTop: '40px', marginBottom: '10px' }}>TÉRMINOS Y CONDICIONES</h4>
                <p style={{ textAlign: 'justify', fontSize: '14px', lineHeight: '1.5em' }}>
                  Esta cotización es válida por 5 días hábiles a partir de la fecha de emisión. Los precios están sujetos a cambios sin previo aviso.
                  La contratación del servicio estará sujeta a disponibilidad y a la firma del contrato correspondiente.
                </p>
              </div>
